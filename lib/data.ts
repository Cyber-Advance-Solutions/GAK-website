...
export const FAQ_DATA: Record<
  string,
  { label: string; items: { q: string; a: string }[] }
> = {
  gen: {
    label: "General",
    items: [
      {
        ...
        a: "School operates Monday–Friday, 7:30 AM to 1:30 PM, with adjusted winter timings announced via circular.",
      },
      {
        q: "Which streams does GAK offer?",
        a: "Two parallel streams — APSACS (FBISE national curriculum) and APSIS (Cambridge international).",
      },
      {
        q: "Is transport available?",
        a: "Yes, school transport covers major routes within and around Kharian Cantt. Details are shared at enrolment.",
      },
    ],
  },
  fee: {
    ...
    items: [
      {
        ...
        a: "Fees are charged quarterly. The full structure by class is provided in the prospectus and at the accounts office.",
      },
      {
        q: "Are there sibling concessions?",
        a: "Concessions apply as per APSACS policy. Please confirm eligibility with the accounts department.",
      },
    ],
  },
  adm: {
    ...
    items: [
      {
        ...
        a: "Main admissions open in January–February for the new session. Mid-session seats are subject to availability.",
      },
      {
        q: "Is there an entry test?",
        a: "Yes, for Class I and above. Pre-School admissions are based on an interaction only.",
      },
    ],
  },
  exam: {
    ...
    items: [
      {
        ...
        a: "The academic year is divided into terms with periodic assessments and two major examinations.",
      },
      {
        q: "Where can I see datesheets?",
        a: "Examination schedules are published on each section page and in the Downloads area.",
      },
    ],
  },
  hire: {
    ...
    items: [
      {
        q: "How do I apply for a teaching post?",
        a: "Apply through the Google Form linked in the HR & Careers section against the relevant vacancy.",
      },
    ],
  },
  promo: {
    ...
    items: [
      {
        q: "What is the promotion criteria?",
        a: "Promotion is based on cumulative assessment, attendance and conduct, as detailed on each section's page.",
      },
    ],
  },
};

export const CHAT_QA: Record<
  string,
  { label: string; qa: [string, string][] }
> = {
  general: {
    label: "General",
    qa: [
      [
        ...
        "School runs Mon–Fri, 7:30 AM–1:30 PM. Winter timings are announced via circular.",
      ],
      [
        "Which streams do you offer?",
        "Two streams — APSACS (FBISE) and APSIS (Cambridge international).",
      ],
      [
        "Is transport available?",
        "Yes, transport covers major routes in and around Kharian Cantt.",
      ],
    ],
  },
  admission: {
    ...
    qa: [
      [
        ...
        "Main admissions open Jan–Feb for the new session. Apply online from the Admissions page.",
      ],
      [
        "Is there an entry test?",
        "Yes, for Class I and above. Pre-School is interaction-based only.",
      ],
      [
        "What documents are needed?",
        "Birth certificate, previous result, B-form/CNIC copies and passport photos.",
      ],
    ],
  },
  fee: {
    ...
    qa: [
      [
        "How is fee charged?",
        "Fees are billed quarterly. Full structure is in the prospectus and at accounts.",
      ],
      [
        "Are concessions available?",
        "Sibling and merit concessions apply per APSACS policy.",
      ],
    ],
  },
  exam: {
    ...
    qa: [
      [
        "Where are datesheets shared?",
        "On each section page and in the Downloads area.",
      ],
      [
        "How are students assessed?",
        "Through term assessments plus two major examinations per year.",
      ],
    ],
  },
};
